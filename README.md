🛡️ Cibersecurity & SOC Portfolio Hola 👋, soy Fernando Díaz. Este repositorio compila mis proyectos de infraestructura segura, auditoría y laboratorios prácticos, orientados a la Defensa Activa y Operaciones de Seguridad (SOC).
...
🚀 Proyectos Destacados (Real World Scenarios) Sentinel - Sistema de Control de Activos: Desarrollo de una herramienta de auditoría para la identificación de hardware no autorizado y eliminación de puntos ciegos en la red.
...
🧠 Habilidades Técnicas Defensa SOC: Monitoreo de activos, triaje de incidentes y análisis de registros.
...
🧰 Stack Tecnológico Defensa y Monitoreo (Blue Team) SIEM/XDR: Wazuh.
...
Análisis Ofensivo (Red Team) Sistemas: Kali Linux, Debian.

Web & Network: Burp Suite, Gobuster, Metasploit, Nikto.

🔍 Laboratorios Incluidos Análisis ARP: Auditoría de tráfico de capa 2 para detección de dispositivos.
...
🔐 Ética y Alcance Todas las pruebas fueron realizadas en entornos de laboratorio o bajo autorización formal en contextos profesionales.
